...
class ObjectTracker:
    def __init__(self):
        # save the center locations of the objects
        self.center_positions = {}
        # save the count of the IDs
        # every time a new object id is determinated, the count will be increased by one
        self.id_count = 0
    ...
    def update(self, objects_rect):
        ...
        for rect in objects_rect:
            ...
            for id, pt in self.center_positions.items():
                distance = math.hypot(cx - pt[0], cy - pt[1])

                if distance < 25:
                    # update the center point
                    self.center_positions[id] = (cx, cy)
            ...
            if same_object_detected is False:
                # print(False)
                self.center_positions[self.id_count] = (cx, cy)
        ...
        for obj_bb_id in objects_bbs_ids:
            ...
            center = self.center_positions[object_id]
        ...
        self.center_positions = new_center_positions.copy()
